...
| 2.4.3 Fookustamise järjekord | ✓ | ✓ | ✓ | ✓ | Kõik valitud tööriistad tuvastasid positiivse `tabindex`i olemasolu. WAVE, Silktide ja Accessibility Insights näitavad fookustamise järjekorda visuaalselt | WAVE |
...
| 3.1.1 Lehekülje keel | ✓ | ✓ | ✓ | ✓ | Kõik valitud tööriistad tuvastasid `lang`-atribuudi puudumise. WAVE, Silktide ja Accessibility Insights tuvastasid ka ebakorrektse keeleparameetri. | WAVE |
