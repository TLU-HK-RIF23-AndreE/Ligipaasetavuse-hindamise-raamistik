...
| 1.4.2 | 9.1.4.2 | Helitugevuse kontrollimine | A | M | Manuaalselt tuleb kontrollida, kas üle kolme sekundi kestvat heli on võimalik peatada, vaigistada või selle helitugevust reguleerida ilma süsteemi helitugevust muutmata. |
